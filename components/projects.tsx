      ...
      <div className="section-shell">
        ...
        <div className="grid gap-6 xl:grid-cols-3">
          {mainProjects.map((project, index) => (
            <article
              key={project.title}
              className={`glass-panel group flex flex-col rounded-[28px] p-7 transition-all hover:-translate-y-1 hover:border-primary/40 ${
        ...
        <div className="mt-12 rounded-[28px] border border-border bg-card/70 p-6 md:p-8">
          <div className="mb-6 flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm leading-7 text-muted-foreground">
                Outros trabalhos que reforcam minha experiencia pratica com interfaces, CRUDs e
                aplicacoes web publicadas.
              </p>
            </div>
            <a
              href={profile.github}
